...
us_data = np.array([98, 118, 149, 217, 262, 402, 518, 583, 959, 1.3e3, 1.7e3, 2.2e3, 2.7e3, 2.9e3, 3.5e3, 4.6e3, 6.4e3, 7.8e3, 13.7e3, 19.1e3, 25.5e3, 33.3e3, 43.8e3, 53.7e3, 65.8e3, 83.8e3, 101.7e3, 121.5e3, 140.9e3, 161.8e3, 188.2e3,
                    213.4e3, 243.5e3, 275.6e3, 308.9e3, 337.1e3, 366.6e3, 396.2e3, 429.1e3, 461.4e3, 496.5e3, 526.4e3, 555.3e3, 580.6e3, 607.7e3, 636.4e3, 667.8e3, 699.7e3, 732.2e3, 759.1e3, 784.3e3, 812e3, 840.2e3])
...
fig, (ax1, ax2, ax3) = interactive_subplots(3, 1, figsize=(20,10), constrained_layout=True, show_xlabel=True, xformat=xformat, show_yline=True, autoscale=True)
